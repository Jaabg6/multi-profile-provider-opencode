...
function serializeToolResult(result: ToolJsonResult): string {
  return JSON.stringify(result);
}

async function runTool(execute: () => Promise<ToolJsonResult>): Promise<string> {
  try {
  ...
  return {
    "tool.register": async (_input: unknown, output: any) => {
      ...
      output.register({
        ...
        execute: async (args: { id: string; label: string }) => runTool(async () => service.createProfile(args))
      });
      ...
      output.register({
        ...
        execute: async (args: { id: string; label: string }) =>
          runTool(async () => {
